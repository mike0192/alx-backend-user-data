...
class BasicAuth(Auth):
    ...
    def extract_user_credentials(
        ...
        """Extracts user credentials from a base64-decoded auth header.
        Args:
          - decoded_base64_authorization_header: The decoded header string.
        Return:
          - A tuple (user, password) or (None, None) if extraction fails.
        """
    ...
    def user_object_from_credentials(
        ...
        """Retrieves a user based on authentication credentials.
         Args:
